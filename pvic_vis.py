...
class PViC(nn.Module):
    ...
    def __init__(self,
        ...
        feature_head: FeatureHead, ho_matcher: HumanObjectMatcher,
        triplet_decoder: TransformerDecoder, num_verbs: int,
    ...
    def forward(self,
        ...
        if self.training:
            ...
            cls_loss, n_p = self.compute_classification_loss(logits, prior_scores, labels)
            loss_dict = dict(cls_loss=cls_loss)
            return loss_dict, n_p
...
def build_detector(args, obj_to_verb) -> PViC:
